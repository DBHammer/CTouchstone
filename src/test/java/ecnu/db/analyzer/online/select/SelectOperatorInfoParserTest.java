...
public class SelectOperatorInfoParserTest {
    ...
    void testParse() throws Exception {
        SelectNode node = SelectOperatorInfoParser.parse("ge(db.table.col, 2)");
    ...
    void testParseWithArithmeticOps() throws Exception {
        SelectNode node = SelectOperatorInfoParser.parse("ge(mul(db.table.col1, plus(db.table.col2, 3)), 2)");
    ...
    void testParseWithLogicalOps() throws Exception {
        SelectNode node = SelectOperatorInfoParser.parse("or(ge(db.table.col1, 2), lt(db.table.col2, 3))");
    ...
    void testParseWithLogicalOpsFailed() {
        assertThrows(TouchstoneToolChainException.class, () -> {
            SelectOperatorInfoParser.parse("or(ge(db.table.col1, 2), mul(db.table.col2, 3))");
        });
    }
}