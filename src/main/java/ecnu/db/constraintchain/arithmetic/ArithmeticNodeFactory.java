...
public class ArithmeticNodeFactory {
    public static ArithmeticNode create(ArithmeticNodeType type) throws TouchstoneException {
        ArithmeticNode node;
        switch (type) {
            case DIV:
                node = new DivNode();
            ...
            case COLUMN:
                ...
                break;
            default:
                throw new TouchstoneException(String.format("未识别的ArithmeticNodeType %s", type));
        }
