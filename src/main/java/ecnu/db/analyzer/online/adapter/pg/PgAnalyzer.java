...
public class PgAnalyzer extends AbstractAnalyzer {
    ...
    private static final String NUMERIC = "'\\d+'::numeric";
    private static final String INTEGER = "'(0|[1-9]\\d*|-[1-9]\\d*)'::integer";
    private static final String DATE1 = "\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}\\.\\d{6}";
    private static final String DATE2 = "\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}";
    private static final String DATE3 = "\\d{4}-\\d{2}-\\d{2}";
    private static final String DATE = String.format("'(%s|%s|%s)'::date", DATE1, DATE2, DATE3);
    private static final String TIMESTAMP1 = "\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}\\.\\d{6}";
    private static final String TIMESTAMP2 = "\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2}";
    private static final String TIMESTAMP3 = "\\d{4}-\\d{2}-\\d{2}";
    public static final String TIME_OR_DATE = String.format("(%s|%s|%s|%s|%s|%s)", DATE1, DATE2, DATE3, TIMESTAMP1, TIMESTAMP2, TIMESTAMP3);
    private static final String TIMESTAMP = String.format("'(%s|%s|%s)'::timestamp(\\(\\d+\\))? without time zone", TIMESTAMP1, TIMESTAMP2, TIMESTAMP3);
